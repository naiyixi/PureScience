---
name: ligandmpnn
description: 使用 LigandMPNN（Dauparas 等 2023，github.com/dauparas/LigandMPNN）对带配体、核酸和金属上下文的骨架进行逆折叠。用于重新设计结合口袋内壁残基、设计必须满足几何约束的金属配位位点、或从任意 MPNN 运行获取线程化设计序列 PDB。
license: Apache-2.0
category: biomodels
metadata:
