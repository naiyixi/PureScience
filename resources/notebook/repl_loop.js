...
const RPC_ENDPOINT = process.env.PURESCIENCE_MCP_RPC_ENDPOINT
const RPC_SOCKET_PATH = process.env.PURESCIENCE_MCP_RPC_SOCKET_PATH
const RPC_TOKEN = process.env.PURESCIENCE_MCP_RPC_TOKEN
delete process.env.PURESCIENCE_MCP_RPC_ENDPOINT
delete process.env.PURESCIENCE_MCP_RPC_SOCKET_PATH
delete process.env.PURESCIENCE_MCP_RPC_TOKEN
...
const COMPUTE_SESSION_ID = process.env.PURESCIENCE_NOTEBOOK_SESSION_ID
const COMPUTE_PROJECT_NAME = process.env.PURESCIENCE_NOTEBOOK_PROJECT_NAME
delete process.env.PURESCIENCE_NOTEBOOK_SESSION_ID
delete process.env.PURESCIENCE_NOTEBOOK_PROJECT_NAME
...
const runtimeRootValue = process.env.PURESCIENCE_RUNTIME_DIR
...
const runtimeTextReferencesManagedRuntime = (text) => {
  ...
  return (
    String(text).includes('PURESCIENCE_RUNTIME_DIR') ||
...
const resolvedCommandCwd = (target, cwd) => {
  ...
  const expanded = managedRuntimeRoot
    ? unquoted
        .replace(/\$\{?env:PURESCIENCE_RUNTIME_DIR\}?/giu, () => managedRuntimeRoot)
        .replace(/\$\{?PURESCIENCE_RUNTIME_DIR\}?/gu, () => managedRuntimeRoot)
        .replace(/%PURESCIENCE_RUNTIME_DIR%/giu, () => managedRuntimeRoot)
    : unquoted
