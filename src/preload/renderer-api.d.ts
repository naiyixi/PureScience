...
export interface PureScienceAPI {
  ...
  specialist: {
    ...
    marketplaceList(request?: ListMarketplaceRequest): Promise<MarketplaceSnapshot>
    marketplaceInspectGithubSource(
      request: InspectGitHubMarketplaceSourceRequest
    ): Promise<MarketplaceSourceCandidate>
    marketplaceAddSource(request: AddMarketplaceSourceRequest): Promise<MarketplaceSourceView>
    marketplaceRemoveSource(request: RemoveMarketplaceSourceRequest): Promise<void>
    marketplaceGetRelease(
      request: GetMarketplaceReleaseRequest
    ): Promise<MarketplaceSpecialistRelease>
    marketplacePrepareInstall(
      request: PrepareMarketplaceInstallRequest
    ): Promise<MarketplaceInstallPreview>
    marketplaceCancelCandidate(request: CancelMarketplaceCandidateRequest): Promise<void>
    marketplaceInstall(request: MarketplaceInstallRequest): Promise<MarketplaceInstallResult>
    onMarketplaceDownloadProgress(
      listener: AcpListener<MarketplaceDownloadProgress>
    ): RemoveListener
  }
  handoff: {
  ...
  storage: {
    ...
    // The final data root is always `<parent>/PureScience`, never the parent itself.
    ...
    // `dataRoot` on the result is the derived `<parent>/PureScience` path.
