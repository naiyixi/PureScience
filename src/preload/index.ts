...
const api: PureScienceAPI = {
  ...
  egress: {
    onApprovalRequest: (listener) =>
      electronRendererContracts.subscribe('egress.onApprovalRequest', listener),
    respondApproval: (request) =>
      electronRendererContracts.invoke('egress.respondApproval', request)
  },
  folderGrants: {
  ...
  settings: {
    ...
    xaiOauthStart: () => electronRendererContracts.invoke('settings.xaiOauthStart'),
    xaiOauthComplete: (request) =>
      electronRendererContracts.invoke('settings.xaiOauthComplete', request),
    xaiOauthRefresh: (request) =>
      electronRendererContracts.invoke('settings.xaiOauthRefresh', request),
    xaiOauthStatus: (request) =>
      electronRendererContracts.invoke('settings.xaiOauthStatus', request),
    xaiOauthLogout: (request) =>
      electronRendererContracts.invoke('settings.xaiOauthLogout', request),
  ...
  specialist: {
    ...
    marketplaceList: (request?: ListMarketplaceRequest) =>
      electronRendererContracts.invoke('specialist.marketplaceList', request),
    marketplaceInspectGithubSource: (request: InspectGitHubMarketplaceSourceRequest) =>
      electronRendererContracts.invoke('specialist.marketplaceInspectGithubSource', request),
    marketplaceAddSource: (request: AddMarketplaceSourceRequest) =>
      electronRendererContracts.invoke('specialist.marketplaceAddSource', request),
    marketplaceRemoveSource: (request: RemoveMarketplaceSourceRequest) =>
      electronRendererContracts.invoke('specialist.marketplaceRemoveSource', request),
    marketplaceGetRelease: (request: GetMarketplaceReleaseRequest) =>
      electronRendererContracts.invoke('specialist.marketplaceGetRelease', request),
    marketplacePrepareInstall: (request: PrepareMarketplaceInstallRequest) =>
      electronRendererContracts.invoke('specialist.marketplacePrepareInstall', request),
    marketplaceCancelCandidate: (request: CancelMarketplaceCandidateRequest) =>
      electronRendererContracts.invoke('specialist.marketplaceCancelCandidate', request),
    marketplaceInstall: (request: MarketplaceInstallRequest) =>
      electronRendererContracts.invoke('specialist.marketplaceInstall', request),
    onMarketplaceDownloadProgress: (listener: (progress: MarketplaceDownloadProgress) => void) =>
