...
export const VISION_MODEL_NOT_CONFIGURED_MESSAGE =
  'Attached images need a Vision model, but none is configured. Open Settings → Model → Vision model to pick one.'
export const VISION_IMAGE_INVALID_MESSAGE =
  'An attached image could not be read for Vision analysis. Remove it and re-attach.'
export const VISION_IMAGE_TOO_LARGE_MESSAGE =
  'An attached image is too large for Vision analysis. Attach a smaller image.'
export const VISION_IMAGE_BUDGET_MESSAGE =
  'Too many or too large images for one request. Attach fewer or smaller images.'
export const VISION_EVIDENCE_INVALID_MESSAGE =
  'The Vision model returned invalid image evidence. Try again or attach a clearer image.'
export const VISION_EVIDENCE_BUDGET_MESSAGE =
  'The prepared image evidence exceeds the request budget. Attach fewer images.'
