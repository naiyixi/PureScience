...
export const RENDERER_CONTRACT_GROUPS = Object.freeze([
  ...
  group('project-files', 'projectFiles', [
    ...
    ['listFiles', 'project-files:list-files'], ['listKinds', 'project-files:list-kinds'], ['repairIndex', 'project-files:repair-index'], ['searchArtifacts', 'project-files:search-artifacts'],
  ]),
  group('search', 'search', [
    ['query', 'search:query', LOCAL], ['evidence', 'search:evidence', LOCAL]
  ]),
  ...
  group('searchPins', 'searchPins', [
    ['list', 'search-pins:list', LOCAL], ['remove', 'search-pins:remove', LOCAL], ['save', 'search-pins:save', LOCAL],
  ]),
  ...
  group('sessions', 'sessions', [
    ...
    ['listCatalog', 'sessions:list-catalog'], ['loadAll', 'sessions:load-all'], ['readDocument', 'sessions:read-document'], ['saveManifest', 'sessions:save-manifest'],
  ...
  group('settings', 'settings', [
    ...
    ['detectOpencode', 'settings:detect-opencode'], ['exportCustomServerTemplate', 'settings:export-custom-server-template', ELECTRON], ['exportSkill', 'settings:export-skill', ELECTRON], ['getAutoApply', 'settings:get-auto-apply', LOCAL], ['getConnectorDetail', 'settings:get-connector-detail'],
    ...
    ['setUiLanguage', 'settings:set-ui-language', LOCAL],
    ...
    ['setAutoApply', 'settings:set-auto-apply', LOCAL],
  ...
  group('specialist', 'specialist', [
    ...
    ['marketplaceAddSource', 'specialist:marketplace-source-add', ELECTRON], ['marketplaceCancelCandidate', 'specialist:marketplace-candidate-cancel', ELECTRON],
    ['marketplaceGetRelease', 'specialist:marketplace-release-get', ELECTRON], ['marketplaceInspectGithubSource', 'specialist:marketplace-source-inspect-github', ELECTRON],
    ['marketplaceInstall', 'specialist:marketplace-install', ELECTRON], ['marketplaceList', 'specialist:marketplace-list', ELECTRON],
    ['marketplacePrepareInstall', 'specialist:marketplace-install-prepare', ELECTRON], ['marketplaceRemoveSource', 'specialist:marketplace-source-remove', ELECTRON],
