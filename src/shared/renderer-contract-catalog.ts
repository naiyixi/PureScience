...
export const RENDERER_CONTRACT_GROUPS = Object.freeze([
  ...
  group('settings', 'settings', [
    ...
    ['getCredentials', 'settings:list-credentials', LOCAL], ['getSkillDetail', 'settings:get-skill-detail'], ['getEgress', 'settings:get-egress', LOCAL], ['importAgentHomeSkills', 'settings:import-agent-home-skills', MAPPED_ELECTRON],
