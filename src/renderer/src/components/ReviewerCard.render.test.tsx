...
describe('ReviewerCard — running state', () => {
  it('renders only the transparent branded status row while the review is running', async () => {
    ...
    expect(container.querySelector('[data-testid="purescience-thinking-indicator"]')).not.toBeNull()
    ...
    expect(container.querySelector('[data-testid="purescience-thinking-indicator"]')).toBeNull()
  })
})
