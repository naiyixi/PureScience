...
type LegacyDataMoveDialogProps = {
  ...
  // The parent the "Move to PureScience" action relocates into; its derived data root (resolved via
  // inspectDataRoot below) is the visible <parent>/PureScience folder.
...
// hidden config root. Offers to move it into the visible PureScience folder (default or a folder the
    ...
    try {
      ...
      setPickError(
        inspection.kind === 'adopt'
          ? 'That folder already contains PureScience data. Pick an empty folder, or use the default location.'
