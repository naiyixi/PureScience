...
export const en: Record<ZhKey, string> = {
  ...
  'ws.replay.hint': 'Runs the recorded version through the same command the remote API calls.',
  'ws.replay.failed': 'The replay could not be run.',
  'ws.replay.mode.reRun': 'Re-run: a fresh execution',
  'ws.replay.mode.recordIntegrity': 'Record integrity: the recorded bytes',
  'ws.replay.verdict.reproduced': 'Reproduced: every comparable output came back byte-identical.',
  'ws.replay.verdict.intact': 'Intact: the recorded digests still match the bytes on disk.',
  'ws.replay.verdict.differs': 'Differs: the re-run does not match the record.',
  'ws.replay.verdict.changed': 'Changed: the bytes on disk no longer match the record.',
  'ws.replay.verdict.unverifiable': 'Unverifiable: this could not be checked.',
  'ws.replay.origin.executed': 'recorded from an execution',
  'ws.replay.origin.reconstructed': 'recorded from a reconstructed recipe',
  'ws.replay.stopped.noRecordedCode': 'Nothing was recorded to re-run.',
  'ws.replay.stopped.versionUnreadable': 'The version could not be read.',
  'ws.replay.stopped.notConfigured': 'Replay is not configured on this machine.',
  'ws.replay.stopped.unknown': 'The replay stopped before comparing anything.',
  'ws.replay.environment.applied': 'The environment lock was applied.',
  'ws.replay.environment.notApplied': 'The environment lock was not applied.',
  'ws.replay.manifestChecksum': 'manifest {checksum}',
  'ws.replay.execution.skipped': 'Not executed: the recipe was reconstructed.',
  'ws.replay.execution.summary': 'via {via} · exit {exitCode} · {durationMs} ms',
  'ws.replay.execution.timedOut': 'timed out',
  'ws.replay.reasons': 'Why the report says so',
  'ws.replay.files': 'Files compared',
  'ws.replay.filesEmpty': 'No files were recorded for this version.',
  'ws.replay.file.match': 'matches',
  'ws.replay.file.differs': 'differs at byte {byte} (recorded {original}, replay {replay})',
  'ws.replay.file.missing': 'missing from the replay',
  'ws.replay.file.extra': 'not in the record',
  'ws.replay.reason.noDigestRecorded': 'no digest was recorded',
  'ws.replay.reason.sizeBeyondBound': 'too large for a byte comparison',
  'ws.replay.reason.appVersionMismatch': 'recorded by another app version',
  'ws.replay.reason.unsupportedOutputKind': 'this output kind is not compared',
  ...
  'pdf.table.menu': 'Table candidates (verify against the source)',
  ...
  'pdf.table.copyMarkdown': 'Copy Markdown',
  'pdf.table.copyTsv': 'Copy TSV',
  'pdf.table.copyHtml': 'Copy HTML',
  'pdf.table.copied': 'Copied',
  'pdf.table.unavailable': 'The PDF reader is unavailable on this surface.',
  'pdf.explore.title': 'Contents and figures',
  'figureReview.title': 'Figure review',
  'figureReview.hint':
    'Answers only what a reader of the figure can see; the data-handling rules need the figure’s author to declare them.',
  'figureReview.unavailable': 'Figure review is unavailable',
  'figureReview.panelId': 'Panel id',
  'figureReview.chartType': 'Chart type',
  'figureReview.seriesCount': 'Series drawn',
  'figureReview.labelCount': 'Axis/legend labels',
  'figureReview.fontPt': 'Smallest font (pt)',
  'figureReview.logAxis': 'Log axis',
  'figureReview.logTicks': 'Log tick labels',
  'figureReview.logTicksPlaceholder': '0.01, 0.1, 1, 10',
  'figureReview.shape': 'Data shape',
  'figureReview.shapeTimeSeries': 'time series',
  'figureReview.shapeCategorical': 'categorical',
  'figureReview.shapeDistribution': 'distribution',
  'figureReview.shapeRelationship': 'relationship',
  'figureReview.rendered': 'Rendered and inspected',
  'figureReview.imagePath': 'Rendered image path',
  'figureReview.scriptPath': 'Plotting script path',
  'figureReview.authorOnly':
    'Whether excluded rows leaked into summary statistics can only be declared by the figure’s author — a clean result here does not cover that rule.',
  'figureReview.run': 'Run the checks',
  'figureReview.violationCount': '{count} finding(s)',
  'figureReview.clean': 'No violations for what was declared.',
  'pdf.explore.unavailable': 'PDF exploration is unavailable',
  'pdf.explore.outlineHeading': 'Contents',
  'pdf.explore.outlineHint':
    'From the document’s own bookmarks; levels and page order are not rewritten.',
  'pdf.explore.outlineEmpty': 'This document declares no bookmarks.',
  'pdf.explore.figuresHeading': 'Figures',
  'pdf.explore.figuresScanned': 'Scan of {pages} pages',
  'pdf.explore.figuresEmpty': 'Scanned {pages} pages; the extractor accepted no figures.',
  'pdf.explore.figuresSkipped': 'Another {count} placements were too small to count as figures.',
  'pdf.explore.figuresWithoutCaption': '{count} of them carry no caption in the document.',
  'pdf.explore.figurePage': 'p. {page}',
  'pdf.explore.figureCaptionNone': 'The document gives no caption.',
  'pdf.explore.warningsHeading': 'Check first',
  ...
  'plan.reject': 'Reject',
  'plan.confidence': '{level} confidence',
  'plan.scopeFeasibility': 'SCOPE & FEASIBILITY',
  'ws.loadingNotebook': 'Loading notebook…',
  'ws.reviewerStatusOk': 'ok',
  'ws.reviewerStatusError': 'error',
  'ws.reviewerTitle': 'Session Reviewer',
  'ws.agentThinking': 'Thinking',
  'ws.agentSlowHint': '· taking longer than usual',
  'ws.previewUnavailable': 'Preview unavailable',
  'ws.fileUnavailable': 'File unavailable',
  'ws.previewUnsupported': 'This file type isn’t supported for preview',
  'ws.previewSheetTitle': 'Preview',
  'ws.previewSheetDescription': 'Open files, generated artifacts, code, and notebooks.',
  'ws.addLocalFolder': 'Add local folder…',
  'ws.addSshHost': 'Add SSH host…',
  'ws.sessionBookmark': 'Sessions and bookmarks',
  'ws.referencesLibrary': 'References',
  'common.soon': 'Soon',
  'specialist.unavailable': 'Unavailable',
  'specialist.removedPermanently': 'will be permanently removed',
  ...
  'figure.phaseReady': 'Ready to export (keep clicking to add points, or undo)',
  'figure.tickValueMissing': 'Type the value of this tick mark first, then click its pixel',
  'figure.xAnchorProgress': 'x anchors {count}/2',
  'figure.yAnchorProgress': 'y anchors {count}/2',
  ...
  'figure.undoPoint': 'Undo last point',
  'figure.restart': 'Start over',
  'figure.exportCsv': 'Export CSV (estimated)',
  'figure.clearPoints': 'Clear data points',
  'figure.source': 'Source',
  'figure.pageLabel': 'Page',
  'figure.figureRefLabel': 'Figure',
  'figure.figureRefPlaceholder': 'e.g. Fig. 3B',
  'figure.pageRequired': 'Confirm the page: a missing or wrong page number breaks provenance',
  'figure.pageInvalid':
    'The page must be an integer ≥ 1; otherwise the extraction fails the provenance audit.',
  'figure.errorFiniteAnchor': 'An anchor pixel and value must both be finite numbers',
  'figure.errorDuplicateAnchor': 'Two anchors cannot share the same pixel',
  'figure.errorAxisComplete': 'The x axis already has both anchors',
  'figure.errorNeedXAnchors': 'Calibrate both x-axis anchors first',
  'figure.errorCalibrationIncomplete': 'Calibration is incomplete: two anchors per axis',
  'figure.errorPointFinite': 'Data point coordinates must be finite numbers',
  'figure.errorAnchorsRequired': 'Calibration is incomplete: x and y need two anchors each',
  ...
  'artifact.reconstructionSuffix': ' for the raw record',
  'artifact.generatingScript': 'Generating script…',
  ...
  'artifact.modelNotTriggered': 'Model · not triggered',
  'permissionScope.settingsPath': 'Settings → Permissions',
  'permissionScope.thisPermission': 'this permission',
  'permissionScope.scopeProject': 'for this project',
  'permissionScope.scopeGlobal': 'globally',
  'permissionScope.coverageProject': 'for every session in this project',
  'permissionScope.coverageGlobal': 'for every session in every project',
  'permissionScope.effectCode': 'Code will run without preview {coverage}.',
  'permissionScope.effectActions': 'Matching actions can run without another approval {coverage}.',
  'permissionScope.title': 'Allow {subject} {scope}?',
  'permissionScope.revokeHint': 'You can revoke it in',
  'permissionScope.allowProject': 'Allow for this project',
  'permissionScope.allowGlobal': 'Allow globally',
  ...
  'shortcuts.moveInList': 'Move through the list',
  'shortcuts.runRow': 'Run the highlighted item',
  'shortcuts.dismiss': 'Close the dialog or panel',
  'palette.footerNavigate': 'navigate',
  'palette.footerOpen': 'open',
  'palette.footerMention': 'mention',
  ...
  'settings.connectorsBulkScope': 'Applies to the {count} connectors shown',
  'settings.connectorsBulkEnable': 'Enable all {count}',
  'settings.connectorsBulkDisable': 'Disable all {count}',
  'settings.connectorsBulkSummary':
    '{changed} changed · {unchanged} already in that state · {failed} not applied',
  'settings.connectorsBulkChanged': 'changed',
  'settings.connectorsBulkUnchanged': 'already in that state',
  ...
  'settings.step1Run': 'Step 1 · Run',
  'settings.step2Paste': 'Step 2 · Paste the token printed by setup-token',
  'settings.hostNameExample': 'e.g. biowulf, lab-gpu, coder.myworkspace',
  ...
  'settings.loadingHosts': 'Loading hosts…',
  'settings.preparingPreview': 'Preparing preview…',
  'settings.testing': 'Testing…',
  'settings.pathOpenFailed': 'Couldn’t open this path.',
  ...
  'settings.newerVersionElsewhere': 'Someone else saved a newer version',
  'settings.gbRam': 'GB RAM',
  'settings.autoGeneratedFromProbe': '(auto-generated from probe)',
  'settings.directSsh': 'Direct SSH',
  ...
  'ws.marketplaceBatchSelected': '{count} selected',
  'ws.marketplaceBatchInstall': 'Install selected',
  'ws.marketplaceBatchClear': 'Clear selection',
  'ws.marketplaceBatchRunning': 'Installing…',
  'ws.marketplaceBatchSummary': '{installed} installed · {skipped} skipped · {failed} failed',
  'ws.marketplaceBatchSkipped': 'needs attention — install it on its own',
  'ws.marketplaceBatchFailed': 'failed',
  ...
  'ws.marketplaceSort': 'Sort',
  'ws.marketplaceSortVersion': 'Newest version',
  ...
  'ws.usageInput': 'Input',
  'ws.usageCacheRead': 'Cache read',
  'ws.usageCacheWrite': 'Cache write',
  'ws.usageCache': 'Cache',
  'ws.usageOutput': 'Output',
  'ws.usageAriaAvailable': 'Token usage for this response',
  'ws.usageAriaUnavailable': 'Token usage unavailable for this response',
  'ws.usageAriaBreakdownUnavailable': 'Token usage breakdown unavailable',
  'ws.usageAriaTotal': 'Total {total} tokens',
  'ws.usageTurnOne': 'turn',
  'ws.usageTurnMany': 'turns',
  'ws.usageAgentPrefix': 'Agent: ',
  'ws.usageModelPrefix': 'Model: ',
  'ws.composerSlashSkills': '/ skills',
  'ws.composerAtFiles': '@ files',
  'ws.composerHashSessions': '# sessions',
  'ws.composerSearchHint': '{k} search',
  'ws.composerHistoryHint': '↑↓ history',
  ...
  'sidebar.sessionsNav': 'Sessions',
  'sidebar.emptyActive': 'No conversations yet',
  'sidebar.emptyActiveHint': 'Use New above to start one, or open a project from the library.',
  'sidebar.emptyActiveAction': 'Start a conversation',
  ...
  'previewSurface.bookmarkSelection': 'Bookmark the selected passage',
  'previewSurface.bookmarkNeedsSelection': 'Select a passage in the preview first',
  ...
  'conversation.switchSpecialistFailed': 'Could not switch to {name}',
  ...
  'update.downloadSize': 'Download update ({size})',
  ...
  'reportError.clipboardFailed': 'Could not write to clipboard.',
  'reportError.logRevealUnavailable': 'Log reveal is not available in this environment.',
  'reportError.logRevealFailed': 'Could not reveal the log file.',
  ...
  'agentHome.importedWithFailures': 'Imported {n}; {failed} failed.',
  ...
  'preview.fileMissing': 'This file is no longer available — it may have been moved or deleted.',
  'preview.fileOutside':
    "This file isn't in your current storage location — it may belong to a data folder you moved away from.",
  'preview.loadingCode': 'Preparing code file',
  'preview.loadingCsv': 'Preparing data',
  'preview.loadingFasta': 'Preparing sequence',
  'preview.loadingHtml': 'Preparing document',
  'preview.loadingImage': 'Preparing image',
  'preview.loadingJson': 'Preparing data',
  'preview.loadingMarkdown': 'Preparing document',
  'preview.loadingMolecule': 'Preparing structure',
  'preview.moleculeRenderFailed': 'Could not render structure.',
  'preview.loadingNotebook': 'Preparing notebook',
  'preview.loadingPdb': 'Preparing structure',
  'preview.loadingPdf': 'Preparing document',
  'preview.loadingPresentation': 'Preparing presentation',
  'preview.loadingSpreadsheet': 'Preparing spreadsheet',
  'preview.loadingText': 'Preparing text file',
  'preview.loadingTiff': 'Preparing image',
  'preview.loadingUnknown': 'Preparing preview',
  'preview.loadingWord': 'Preparing document',
  ...
  'providerList.deleteAria': 'Delete',
  ...
  'specialist.needProjectToChat': 'Open a project to chat with the agent',
  'specialist.previewThenFinish': 'Preview a package, then finish setup in the existing editor',
  'specialist.compressed': 'Compressed',
  'specialist.uncompressed': 'Uncompressed',
  'specialist.diagnostics': 'Diagnostics',
  'specialist.target': 'Target',
  'specialist.custom': 'Custom',
  'skillEditor.identity': 'Identity',
  'skillEditor.descriptionHeader': 'Description',
  'skillEditor.contentHeader': 'Content',
  'skillEditor.referencesHeader': 'References',
  'skillEditor.identityHint': 'This is how the agent decides when to use the skill — be specific.',
  'skillEditor.pasteHintA': 'Paste a full SKILL.md — if it has a',
  'skillEditor.pasteHintB': 'metadata block at the top, the fields above auto-fill.',
  'skillEditor.dropToUpload': 'Drop to upload',
  'skillEditor.uploadTitle': 'Upload a SKILL.md or text file',
  'skillEditor.uploadHint': 'Its contents fill the editor; switch back to Write to tweak.',
  'skillEditor.refsSupportSentence':
    'Supporting files (scripts, templates, data) the skill can read at runtime.',
  'skillEditor.refsSavedTail': 'in the skill.',
  'skillEditor.removeAria': 'Remove {name}',
  ...
  'reviewer.goToTranscript': 'Go to transcript',
  'reviewer.rerunning': 'Re-running…',
  'reviewer.rerunReview': 'Re-run review',
  'reviewer.humanEvidence': 'Human-pinned evidence',
  'reviewer.evidenceEmpty': 'No evidence pinned yet',
  'reviewer.evidenceQuery': 'Found by',
  'reviewer.evidenceVerify': 'Recheck',
  'reviewer.evidenceVerified': 'Still matches',
  'reviewer.evidenceChanged': 'Block changed',
  'reviewer.evidenceMissing': 'Block missing',
  'reviewer.evidenceUnreadable': 'Evidence could not be read',
  'checklist.markAddressed': 'Mark addressed',
  'checklist.verificationTitle': 'Verification checklist',
  'checklist.openOfClaims': '{open} open of {total} claims',
  'foldTimeline.title': 'Folded context',
  'foldTimeline.previewSummary': 'Folded transcript preview',
  'foldTimeline.foldCount': '{n} fold{s} — original text kept for {tool}',
  ...
  'gs.captureEvidence': 'Copy evidence line',
  'gs.verifyEvidence': 'Verify',
  'gs.evidenceVerified': 'Evidence verified',
  'gs.evidenceChanged': 'Evidence changed',
  'gs.evidenceMissing': 'Evidence block not found',
  'gs.evidenceTruncated': 'Text truncated - no fingerprint possible',
  'gs.evidenceUnreadable': 'Session unreadable',
  'gs.evidenceHeader': 'Evidence',
  'gs.pinToReview': 'Pin to review',
  'gs.pinNoReviews': 'This session has no review yet',
  'gs.pinChooseReview': 'Choose a review',
  'gs.pinned': 'Pinned to the review',
  'gs.pinFailed': 'Could not pin: the request failed',
  'gs.pinRejectedNotFound': 'Review not found',
  'gs.pinRejectedProject': 'Review belongs to another project',
  'gs.pinRejectedSession': 'Review covers another session',
  'gs.pinRejectedDuplicate': 'Already pinned to this review',
  'gs.pinRejectedUnverified': 'Not pinned: the block no longer verifies',
  'gs.evidenceQuery': 'Query',
  'gs.evidenceTerms': 'Terms',
  'gs.evidenceSnippet': 'Snippet',
  'gs.evidenceFingerprint': 'Fingerprint',
  ...
  'gs.contentNoHits': 'No content matches. Searched {sessions} sessions and {messages} messages.',
  'gs.showMore': '+{n} more matches — show more',
  'gs.filterSender': 'Sender',
  'gs.filterFormat': 'File format',
  'gs.filterReferenceType': 'Reference type',
  'gs.filterAny': 'Any',
  'gs.filterSenderUser': 'Me',
  'gs.filterSenderAgent': 'Agent',
  'gs.filterClear': 'Clear filters',
  'gs.pinsTitle': 'Saved filters',
  'gs.pinsEmpty': 'No saved filter sets yet — use Pin to review on a result to save these filters.',
  'gs.browseEmptyTitle': 'Nothing to browse yet',
  'gs.browseEmptyHint':
    'Type above to search your sessions and artifacts, or start a conversation in the workspace.',
  'gs.noHits': 'No sessions or artifacts match “{query}”.',
  'gs.noHitsHint': 'Try fewer words, or widen the scope to search the full text of a source.',
  'gs.noHitsFilterHint': 'Filters are narrowing this search — clear them to widen it back up.',
  'gs.artifactsLoadMoreRetry': 'Could not load more — retry',
  'gs.artifactsLoadRetry': 'Could not load artifacts — retry',
  'gs.pinsCount': '{n} of {max} saved',
  'gs.pinNamePlaceholder': 'Name this filter set',
  'gs.pinSave': 'Save filters',
  'gs.pinApply': 'Apply',
  'gs.pinRemove': 'Remove',
  'gs.pinSaved': 'Saved',
  'gs.pinNameTaken': 'Another saved set already uses that name',
  'gs.pinLimitReached': 'Too many saved filter sets — remove one first',
  'gs.pinSaveFailed': 'Could not save the filter set',
  'gs.pinNeedsFilters': 'Set at least one filter to save',
  'gs.pinApplied': 'Applied',
  'gs.evidencePinned': 'Saved filters',
  'gs.loadingMore': 'Loading more…',
  ...
  'ws.notebookLoadFailed': 'Failed to load notebook.',
  'ws.sessionArtifactsLoadFailed': 'Could not load session artifacts.',
  'ws.artifactPopupLoading': 'Loading project files…',
  'ws.artifactPopupLoadFailed': 'Could not load project files.',
  'ws.artifactPopupEmpty': 'No artifacts yet.',
  ...
  'ws.permissionBatchSiblings': '{count} more requests need the same decision',
  'ws.permissionBatchAllowAll': 'Allow all',
  'ws.permissionBatchDenyAll': 'Deny all',
  ...
  'jobDetail.deliveryTrigger': 'Trigger',
  'jobDetail.deliveryUpdated': 'Last update',
  'jobDetail.deliveryCopy': 'Copy delivery details',
  'jobDetail.deliveryCopied': 'Copied',
  'jobDetail.status': 'Status',
  'jobDetail.runtime': 'Runtime',
  ...
  'artifactEdit.editAction': 'Edit artifact content',
  'artifactEdit.title': 'Edit artifact',
  'artifactEdit.contentAria': 'Editable artifact content',
  'artifactEdit.publishHint': 'Saving publishes a new version; v{version} stays unchanged.',
  'artifactEdit.loadFailed': 'Could not load the artifact content for editing.',
  'artifactEdit.tooLarge': 'This artifact is too large to edit in the preview.',
  'artifactEdit.saveFailed': 'Could not save the edited version.',
  'artifactEdit.discardPrompt': 'Discard unsaved changes?',
  'artifactEdit.discardKeep': 'Keep editing',
  'artifactEdit.discardAction': 'Discard changes',
  'artifactCompare.openAction': 'Compare versions',
  'artifactCompare.title': 'Compare artifact versions',
  'artifactCompare.baseLabel': 'Base version',
  'artifactCompare.targetLabel': 'Compared version',
  'artifactCompare.swap': 'Swap base and compared version',
  'artifactCompare.addedLineCount': '{n} lines added',
  'artifactCompare.removedLineCount': '{n} lines removed',
  'artifactCompare.noChanges': 'No differences between these versions',
  'artifactCompare.loadFailed': 'Could not load the version contents for comparison.',
  'artifactCompare.tooLarge': 'A version is too large to compare in the preview.',
  'previewFile.chooseVersion': 'Select artifact version',
  ...
  'references.importFromPdf.menu': 'Import references cited in this PDF',
  'references.importFromPdf.title': 'References found in this PDF',
  'references.importFromPdf.running': 'Reading the document…',
  'references.importFromPdf.summary':
    'Added {created} · already present {duplicates} · failed {failed}',
  'references.importFromPdf.truncated': '{count} more identifiers were left for a later import',
  'references.importFromPdf.failedItem': '{doi} — {reason}',
  'references.importFromPdf.empty': 'No DOI was found in this document.',
  'references.importFromPdf.failed': 'The import could not run',
  'references.importFromPdf.unavailable': 'reference import is not available in this window',
  'references.importFromPdf.close': 'Close',
  'references.identifierPlaceholder': 'Enter DOI / PMID / arXiv ID…',
  'references.fetch': 'Fetch metadata',
  'references.fetching': 'Fetching…',
  'references.manualAdd': 'Manual add',
  'references.add': 'Add',
  'references.addToLibrary': 'Add to library',
