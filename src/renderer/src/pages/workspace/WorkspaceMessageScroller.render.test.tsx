...
const createUpload = (overrides: Partial<UploadedAttachment> = {}): UploadedAttachment => ({
  ...
  path: '/Users/example/.purescience/uploads/default-project/session-1/first.png',
  mimeType: 'image/png',
  size: 1024,
  ...overrides
})
...
describe('WorkspaceMessageScroller loading render', () => {
  ...
  it('renders an accessible agent loading row before streamed text arrives', async () => {
    ...
    expect(html).toContain('data-testid="purescience-thinking-indicator"')
  ...
  it('renders generated artifact gallery cards under agent messages', async () => {
        ...
        artifacts: [
          {
            id: 'artifact-1',
            kind: 'managed-file',
            path: '/Users/example/.purescience/artifacts/default-project/session-1/reply-1/result.txt',
            fileUrl:
              'file:///Users/example/.purescience/artifacts/default-project/session-1/reply-1/result.txt',
            name: 'result.txt',
            mimeType: 'text/plain',
            size: 2048,
    ...
    expect(html).not.toContain('href="file:///Users/example/.purescience')
  ...
  it('renders image cards and a more button for larger generated artifact sets without file urls', async () => {
    const artifacts = Array.from({ length: 7 }, (_, index) => ({
      ...
      path: `/Users/example/.purescience/artifacts/default-project/session-1/reply-1/file-${index + 1}.png`,
      fileUrl: `file:///Users/example/.purescience/artifacts/default-project/session-1/reply-1/file-${index + 1}.png`,
    ...
    expect(html).not.toContain('src="file:///Users/example/.purescience')
        ...
        artifacts: [
          {
            id: 'artifact-1',
            kind: 'managed-file',
            path: '/Users/example/.purescience/artifacts/default-project/session-1/prompt-1/user-only.txt',
            fileUrl:
              'file:///Users/example/.purescience/artifacts/default-project/session-1/prompt-1/user-only.txt',
            name: 'user-only.txt',
            mimeType: 'text/plain',
            size: 1024,
            mtimeMs: 1710000000100
          ...
          createMessage({
            ...
            uploads: [
              ...
              createUpload({
                ...
                path: '/Users/example/.purescience/uploads/default-project/session-1/pasted-image-2026-07-08T06-17-25.png'
              })
            ]
          })
        ]
