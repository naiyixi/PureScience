...
describe('PreviewImageContent', () => {
    ...
    window.api = {
      previewResources: {
        acquire: vi.fn().mockResolvedValue({
          id: 'resource-1',
          url: 'purescience-preview://resource-1/photo.png',
          size: 40 * 1024 * 1024,
          mimeType: 'image/png',
          version: 1
        }),
  ...
  it('renders an arbitrarily large image from the managed stream URL', async () => {
    ...
    expect(image?.getAttribute('src')).toBe('purescience-preview://resource-1/photo.png')
  ...
  it('acquires upload-sourced images through the unified resource API', async () => {
    ...
    expect(container.querySelector('img')?.getAttribute('src')).toBe(
      'purescience-preview://resource-1/photo.png'
    )
  })
