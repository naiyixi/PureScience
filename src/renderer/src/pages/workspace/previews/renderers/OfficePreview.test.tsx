...
const OFFICE_PREVIEW_RUNTIME_ORIGIN = 'purescience-office-preview://runtime'
...
const startedResult = (
  ...
  sessionId,
  runtimeUrl: `purescience-office-preview://runtime/office-preview.html?sessionId=${sessionId}`,
  size: 1024,
  limit: 40 * 1024 * 1024
})
