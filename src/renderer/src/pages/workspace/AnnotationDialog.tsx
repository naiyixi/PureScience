    ...
    >
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          data-slot="annotation-dialog"
          onOpenAutoFocus={focusRestore.onOpenAutoFocus}
          onCloseAutoFocus={focusRestore.onCloseAutoFocus}
          className="fixed left-1/2 top-1/2 z-50 w-[min(28rem,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 rounded-xl border bg-card p-4 shadow-lg outline-none"
        >
