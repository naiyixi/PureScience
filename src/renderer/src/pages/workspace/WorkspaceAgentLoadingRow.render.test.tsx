...
describe('WorkspaceAgentLoadingRow', () => {
  it('starts elapsed time when the indicator mounts', () => {
    ...
    const indicator = container.querySelector('[data-testid="purescience-thinking-indicator"]')
    expect(indicator).not.toBeNull()
    expect(
      container.querySelectorAll(
        '[data-testid="purescience-thinking-indicator"] .purescience-thinking-indicator__dot'
      )
    ).toHaveLength(5)
