  ...
  it('passes upload file sources through to the active preview content', async () => {
    usePreviewWorkbenchStore.getState().upsertAndActivateItem(
      createFileItem({
        ...
        title: 'upload.png',
        name: 'upload.png',
        path: '/Users/example/.purescience/uploads/default-project/session-1/upload.png',
        source: 'upload'
      })
    )
    ...
    expect(container.querySelector('[data-testid="file-content"]')?.textContent).toBe(
      'file:image:upload:upload.png:/Users/example/.purescience/uploads/default-project/session-1/upload.png'
    )
