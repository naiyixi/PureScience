...
const STEP_LABELS: Record<WizardStep, TranslationKey> = {
  environment: 'onboarding.stepEnvironment',
  agent: 'onboarding.stepAgentRuntime',
  provider: 'onboarding.stepModelProvider',
  notebook: 'onboarding.stepNotebookRuntime',
  location: 'onboarding.stepDataLocation'
}
...
const OnboardingProgress = ({ step }: { step: WizardStep }): React.JSX.Element => {
  ...
  return (
    <ol aria-label={t('onboarding.setupProgress')} className="mt-7 space-y-3">
