          ...
          <div className="rounded-xl border border-border-200 p-4">
            ...
            {chosenDataRoot ? (
              <p className="mt-2 text-xs text-text-100">
                ...
                >
                  {t('onboarding.useDefaultLocation')}
                </button>
              </p>
            ) : null}
            ...
            {chosenKind === 'adopt' ? (
              <p className="mt-2 text-xs text-text-100">
                This folder already contains PureScience data — it will be used as-is (nothing is
                moved).
              </p>
            ) : null}
        ...
        <AlertDialog.Portal>
          ...
          <AlertDialog.Content className={dialogPanelClassName('w-[min(420px,calc(100vw-2rem))]')}>
            ...
            <AlertDialog.Description className={dialogDescriptionClassName}>
              PureScience will restart to set up your data at{' '}
