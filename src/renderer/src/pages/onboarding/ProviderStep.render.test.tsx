...
describe('ProviderStep', () => {
  ...
  // Switches the auth picker to the isolated "Sign in with PureScience" mode — the only path that
  // runs the browser login (loginIsolatedCodex).
  const switchToIsolatedSignIn = async (): Promise<void> => {
    await selectOption('Codex authentication', 'Sign in with PureScience')
  }
