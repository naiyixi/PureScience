...
const PHASE_LABELS: Record<MigrationPhase, TranslationKey> = {
  scan: 'settings.scanningFiles',
  copy: 'settings.copyingFiles',
  verify: 'settings.verifying',
  delete: 'settings.cleaningUp'
}
