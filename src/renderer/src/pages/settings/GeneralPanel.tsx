    ...
    <div className="space-y-5 p-5">
      ...
      {window.api.platform === 'win32' && window.api.window?.onCloseConfirmRequest ? (
        ...
        >
          <SettingsRow
            ...
            description="Ask each time, keep PureScience running in the tray, or quit the app."
            className="pt-0"
          >
            <Select
      ...
      >
        <SettingsRow
          ...
          description="Selecting a notification brings PureScience back to the front and opens the task."
          className="pt-0"
        >
      ...
      >
        ...
        <p className="mt-3 text-xs text-muted-foreground">
          Once installed, run <code className="font-mono">purescience start</code> to launch the
          backend and open the authenticated URL, then{' '}
          <code className="font-mono">purescience stop</code> to shut it down.{' '}
