  ...
  const submit = async (): Promise<void> => {
    ...
    try {
      ...
      if (result?.ok) {
        ...
        setSubmitError(result.message ?? t('settings.couldNotSaveClaudeToken'))
      }
    } finally {
      ...
      <AlertDialog.Content className={dialogPanelClassName('w-[min(560px,92vw)]')}>
        ...
        {browserSignInPending ? (
          ...
          >
            ...
            <span>
              {t('settings.openingBrowserToSignIn')}
              {t('settings.didntOpenPrefToken')}
            </span>
          </div>
        ) : null}
        ...
        <div className="mt-5 space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  aria-label={t('settings.copyCommand')}
                >
                  {copied ? (
                    <>
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              aria-label={t('settings.claudeSetupToken')}
              value={token}
        ...
        <div className={dialogFooterClassName}>
          ...
          >
            {isSubmitting ? t('settings.signingIn') : 'Sign in'}
          </Button>
        </div>
      </AlertDialog.Content>
    </>
