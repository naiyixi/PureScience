        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2">
              ...
              {ready ? (
                active ? (
                  <Badge>{t('settings.active')}</Badge>
                ) : (
                  <Badge variant="secondary">{t('settings.installed')}</Badge>
                )
              ) : repair ? (
          ...
          <div className="mt-2 space-y-3">
            ...
            {progress ? (
              ...
              <div className="space-y-1.5">
                ...
                <div
                  role="progressbar"
                  aria-label={t('settings.installProgress')}
                  aria-valuemin={0}
                  aria-valuemax={100}
            ...
            {installLogs.length > 0 ? (
              <div>
                {!installError ? (
                  ...
                  >
                    {logVisible ? t('settings.hideLog') : t('settings.showLog')}
                  </button>
                ) : null}
                {logVisible ? (
                  <pre
                    ...
                    aria-label={t('settings.installLog')}
                  >
                    {installLogs.join('')}
                  </pre>
                ) : null}
