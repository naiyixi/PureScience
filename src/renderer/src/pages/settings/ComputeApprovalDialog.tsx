...
//   {t('settings.thisSessionScope')}      — approve for (provider, operation) for this persisted session
//   {t('settings.thisProjectScope')}      — approve for (provider, operation) for all future calls in this project
      ...
      <Dialog.Portal>
        ...
        >
          ...
          <div className="mt-3 space-y-1.5 rounded-lg border border-border bg-muted/40 p-3 text-xs">
            ...
            <div className="flex gap-2">
              <span className="w-16 shrink-0 text-muted-foreground">{t('settings.intent')}</span>
              <span className="min-w-0 break-words text-foreground">{dialogRequest.intent}</span>
            </div>
            <div className="flex gap-2">
              <span className="w-16 shrink-0 text-muted-foreground">{t('settings.command')}</span>
            ...
            {dialogRequest.inputs_summary && (
              <div className="flex gap-2">
                <span className="w-16 shrink-0 text-muted-foreground">{t('settings.inputs')}</span>
