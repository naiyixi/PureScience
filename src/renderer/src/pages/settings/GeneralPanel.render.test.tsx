...
beforeEach(() => {
  ...
  cliApi = {
    getStatus: vi.fn().mockResolvedValue({
      installed: false,
      target: '/home/u/.local/bin/purescience',
      onPath: true
    }),
    install: vi.fn().mockResolvedValue({
      ...
      target: '/home/u/.local/bin/purescience',
      onPath: false,
      pathHint: 'Add /home/u/.local/bin to your PATH to use "purescience".'
    }),
...
describe('GeneralPanel command line tool', () => {
  it('installs the command and surfaces the returned path + PATH hint', async () => {
    ...
    expect(container.textContent).toContain('/home/u/.local/bin/purescience')
