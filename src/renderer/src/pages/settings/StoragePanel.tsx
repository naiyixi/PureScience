    ...
    <div className="space-y-5 p-5">
      {storageRepairActive && storageCheck ? (
        <SettingsSection
          ...
          description="PureScience needs write access to its private configuration directory."
      ...
      <SettingsSection
        title="Data location"
        description="Where PureScience stores your projects, artifacts, and other app data on this device."
