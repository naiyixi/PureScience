...
const ACCESS_MODES: {
  ...
  },
  {
    mode: 'remoteit',
    title: 'App access',
    description: 'Open PureScience from the signed-in mobile app with two-step verification.',
    icon: RadioTower
  },
  {
  ...
  return (
    <div className="space-y-5 p-5" data-testid="remote-control-panel">
      ...
      <SettingsSection
        ...
        description={
          <>
            Choose who can reach this computer&apos;s PureScience workspace. All projects, agents,
              ...
              <div className="grid gap-4 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-start">
                ...
                >
                  <QRCodeSVG
                    ...
                    bgColor="#ffffff"
                    fgColor="#111827"
                    title="Scan to open PureScience"
                  />
      ...
      <p className="mt-5 text-xs leading-relaxed text-muted-foreground">
        Remote.It is a third-party service. PureScience only calls its user-installed desktop CLI
