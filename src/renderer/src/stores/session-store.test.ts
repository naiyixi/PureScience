...
const createArtifactFile = (overrides: Partial<ArtifactFile> = {}): ArtifactFile => ({
  ...
  runId: 'run-1',
  name: 'result.txt',
  path: '/Users/example/.purescience/artifacts/default-project/artifact-session-1/.pending/run-1/result.txt',
  fileUrl:
    'file:///Users/example/.purescience/artifacts/default-project/artifact-session-1/.pending/run-1/result.txt',
  size: 2,
...
const createUploadAttachment = (
  ...
  path: '/Users/example/.purescience/uploads/default-project/.pending/first.png',
  mimeType: 'image/png',
  size: 1234,
  ...overrides
})
...
describe('session store', () => {
  ...
  it('stores uploaded attachments on user messages in insertion order', () => {
    ...
    const secondUpload = createUploadAttachment({
      ...
      path: '/Users/example/.purescience/uploads/default-project/.pending/second.png'
    })
  ...
  it('allows an attachments-only user message and replaces uploads after session binding', () => {
    ...
    const finalizedUpload = createUploadAttachment({
      sessionId: 'transport-session-1',
      path: '/Users/example/.purescience/uploads/default-project/transport-session-1/first.png'
    })
  ...
  it('replaces pending artifact metadata with finalized message files', () => {
    ...
    const finalizedArtifacts = [
      createArtifactFile({
        ...
        messageId: 'message-1',
        runId: undefined,
        path: '/Users/example/.purescience/artifacts/default-project/transport-session-1/message-1/result.txt',
        fileUrl:
          'file:///Users/example/.purescience/artifacts/default-project/transport-session-1/message-1/result.txt'
      })
    ]
              ...
              uploads: [
                {
                  ...
                  path: '/Users/example/.purescience/uploads/default-project/transport-session-1/notes.txt',
                  mimeType: 'text/plain',
                  size: 10
                }
              ],
  ...
  it('keeps a staged upload path until the main process publishes its immutable Version', () => {
    const attachment = createUploadAttachment({
      id: 'staged-upload-1',
      path: '/Users/example/PureScience-DEV/uploads/default-project/.pending/staged.csv'
    })
    const pending = useSessionStore.getState().appendPendingUserMessage({
...
describe('session store public contract', () => {
  ...
  it('keeps production consumers on the public store facade', () => {
    expect(directConsumerPaths()).toEqual([
      ...
      'src/renderer/src/pages/workspace/ExportConversationDialog.tsx',
    ...
    'src/renderer/src/pages/workspace/agent-loading-message.ts',
      ...
      'src/renderer/src/pages/workspace/message-content-subscription.ts',
      ...
      'src/renderer/src/pages/workspace/transcript-render-identity.ts',
      'src/renderer/src/pages/workspace/use-project-artifact-files.ts',
      'src/renderer/src/pages/workspace/use-render-sessions.ts',
