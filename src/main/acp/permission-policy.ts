...
const isArtifactSaveTool = (
  ...
  if (!mcpServerNames.map(canonicalAppMcpServerName).includes('purescience-artifacts')) return false
  ...
  return (
    trustedMcpIdentity === 'purescience-artifacts/write_artifact_file' ||
