...
// means "this PureScience folder is a half-baked/uncommitted staging copy, not the live data root",
...
export const MIGRATION_MARKER_FILENAME = '.purescience-migration.json'
