...
// Resolves the micromamba binary (contract §3). Order: PURESCIENCE_MICROMAMBA_BIN override →
...
// (PROD_SESSION_DIR_NAME, i.e. ~/.purescience) since this module stays electron-free and cannot
...
export const resolveMicromamba = (deps: MicromambaDeps = {}): string | undefined => {
  ...
  const override = env.PURESCIENCE_MICROMAMBA_BIN
