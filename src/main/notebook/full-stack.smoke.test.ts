...
//   RUN_SMOKE=1 PURESCIENCE_TEST_PY_ENV=/path/to/default-python/bin/python \
//   [PURESCIENCE_TEST_R_ENV=/path/to/default-r] npx vitest run src/main/notebook/full-stack.smoke.test.ts
...
// the real user profile (its default storageRoot is $HOME/.purescience -- see package-manager.ts).
