...
export const computePackageMutability = (
  ...
  // App-created overlay: PureScience owns this venv, so installs are always allowed.
  ...
  if (!selection.packageInstallAuthorized) {
    return {
      mutable: false,
      reason:
        'This is your own environment; PureScience is not authorized to modify it. Install the ' +
