...
export const DEFAULT_RUNTIME_CDN_BASE = 'https://github.com/naiyixi/PureScience/releases/download/runtime-v1'
...
export const resolveRuntimeCdnBase = (override?: string): string => {
  const value = override ?? process.env.PURESCIENCE_ENV_CDN_BASE ?? DEFAULT_RUNTIME_CDN_BASE
