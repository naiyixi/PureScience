...
const REGISTRY_PROBE_PATHS: Record<AgentFrameworkId, string> = {
  ...
  codebuddy: '/@tencent-ai%2fcodebuddy-code/latest'
}
...
// runtime. This verifies the permission PureScience actually needs without requesting admin access
...
const verifyStorageAccess = async (storageRoot: string): Promise<void> => {
  ...
  try {
    await writeFile(sentinel, 'purescience', { encoding: 'utf8', flag: 'wx' })
  } finally {
