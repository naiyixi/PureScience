...
export type StoredProvider = {
  ...
  // app. This timestamp records an app-local disconnect so PureScience stops using that profile
...
export type StoredSettings = {
  ...
  // Set once the user has answered the one-time "move your legacy .purescience data into the
  // visible PureScience folder" prompt (by moving, choosing another folder, or declining). Absent
