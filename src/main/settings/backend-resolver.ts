...
const CODEX_BRIDGE_ARTIFACT_TOOLS: ResponsesBridgeNamespacedTool[] = [
  {
    ...
    description:
      'Attach a generated image, chart, report, data export, or archive to the current PureScience response. The file must already exist before using a localPath source.',
