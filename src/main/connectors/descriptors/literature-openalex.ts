...
export type OpenAlexSearchWorksParams = {
  query: string | null
  yearFrom?: number
  yearTo?: number
  workType?: string
...
export const searchOpenAlexWorks = async (
  ctx: ToolContext,
  a: OpenAlexSearchWorksParams
): Promise<{
  query: string | null
  filters: Record<string, string>
  venue_resolved?: unknown
  sort: string
  api_total: number
...
export const OPENALEX_LITERATURE_TOOLS: ToolDescriptor[] = [
  {
    ...
    run: async (ctx, a) =>
      searchOpenAlexWorks(ctx, {
        query: a.query != null ? String(a.query) : null,
        yearFrom: a.year_from != null ? Number(a.year_from) : undefined,
        yearTo: a.year_to != null ? Number(a.year_to) : undefined,
        workType: a.work_type != null ? String(a.work_type) : undefined,
        openAccessOnly: a.open_access_only === true,
        venue: a.venue != null ? String(a.venue) : undefined,
        sort: a.sort != null ? String(a.sort) : 'relevance',
        maxRecords: a.max_records != null ? Number(a.max_records) : 50,
        includeAbstracts: a.include_abstracts === true
      })
  },
  {
