...
const createStorageRoot = async (): Promise<string> => {
  storageRoot = await mkdtemp(join(tmpdir(), 'purescience-artifacts-'))
  return storageRoot
}
...
describe('artifact repository', () => {
  ...
  it('derives the project artifact directory from the app storage root', () => {
    ...
    expect(getProjectArtifactDir('/Users/example/.purescience', 'default-project')).toBe(
      join('/Users/example/.purescience', 'artifacts', 'default-project')
    )
  })
