  ...
  it('rewrites packaged app.asar paths and leaves development paths unchanged', () => {
    expect(
      toUnpackedSpecialistResourcePath(
        '/Applications/PureScience.app/Contents/Resources/app.asar/resources/specialists'
      )
    ).toBe(
      '/Applications/PureScience.app/Contents/Resources/app.asar.unpacked/resources/specialists'
    )
