...
const GROUP_COUNT = 33
const INTERNAL_COMMAND_COUNT = 273
const LOCAL_WEB_COMMAND_COUNT = 271
const REMOTE_WEB_COMMAND_COUNT = 182
const REMOTE_REJECTED_COMMAND_COUNT = 89
