...
const PLAN_MCP_SERVER_NAME = 'purescience-plan'
...
const createPlanMcpServerConfig = ({
  ...
  env: [
    ...
    { name: 'PURESCIENCE_PLAN_RPC_ENDPOINT', value: endpoint },
    ...(socketPath ? [{ name: 'PURESCIENCE_PLAN_RPC_SOCKET_PATH', value: socketPath }] : []),
    { name: 'PURESCIENCE_PLAN_RPC_TOKEN', value: token },
    { name: 'PURESCIENCE_PLAN_PROJECT_ID', value: projectId },
    { name: 'PURESCIENCE_PLAN_SESSION_ID', value: sessionId }
  ]
})
...
const runPlanMcpServer = async (): Promise<void> => {
  const server = createPlanMcpServerForEnvironment({
    endpoint: requireEnvironment('PURESCIENCE_PLAN_RPC_ENDPOINT'),
    socketPath: process.env.PURESCIENCE_PLAN_RPC_SOCKET_PATH,
    token: requireEnvironment('PURESCIENCE_PLAN_RPC_TOKEN'),
    projectId: requireEnvironment('PURESCIENCE_PLAN_PROJECT_ID'),
    sessionId: requireEnvironment('PURESCIENCE_PLAN_SESSION_ID')
  })
