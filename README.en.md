...
> 💡 **[PureScience v1.44.0 released](https://github.com/naiyixi/PureScience/releases/latest)** — community & localization release: **GitHub Discussions** are live (announcements, Q&A, ideas, show-and-tell), the native quit-confirm dialog now follows your system language across all 9 locales, and the v1.40–v1.43 release notes gained English summaries. Version history with release code names: [CHANGELOG](CHANGELOG.md) · Website: [purescience.work](https://purescience.work)
