...
> 💡 **[PureScience v1.43.0 released](https://github.com/naiyixi/PureScience/releases/latest)** — the ecosystem-closing release: a full **English README** (README.en.md), **GitHub-visibility work** (platform badge, an honest internal-acceptance benchmark page, and a Zenodo DOI archiving runbook — PureScience v1.43.0 is archived at DOI 10.5281/zenodo.22441075), and a hardened release pipeline (version.json client manifest published with every release so in-app update checks never 404, figure_review restored, three-platform installers on every release). Version history with release code names: [CHANGELOG](CHANGELOG.md) · Website: [purescience.work](https://purescience.work)
