...
> 💡 **[PureScience v1.48.0 released](https://github.com/naiyixi/PureScience/releases/latest)** — specialist ecosystem batch: the flagship **Autonomous Research Lead specialist now ships built-in and read-only**, with **8 bundled research-method skills** (research contracts, literature search strategy, evidence grading, statistical inference, study design, scientific visualization, methods-writing audit, citation integrity) usable by the main agent and specialists alike, and the **in-app specialist marketplace debuts 5 domain experts** (evidence synthesis, clinical study design, omics & biomarkers, real-world evidence, PK/PD dose modeling) installable in one click. Version history with release code names: [CHANGELOG](CHANGELOG.md) · Website: [purescience.work](https://purescience.work)
